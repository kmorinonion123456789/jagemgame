...
Frame.Size = UDim2.new(0, 220, 0, 600) -- ボタン増量のため少し縦長に調整
...
BuySpeedBtn.BackgroundColor3 = Color3.fromRGB(255, 170, 0)
BuySpeedBtn.TextColor3 = Color3.new(0, 0, 0)
BuySpeedBtn.Font = Enum.Font.GothamBold
BuySpeedBtn.BorderSizePixel = 0

BuySpeedBtn.MouseButton1Click:Connect(function()
    local buyRemote = RS:FindFirstChild("BuySpeed")
    if buyRemote then
        buyRemote:FireServer()
    else
        warn("RemoteEvent 'BuySpeed' が見つかりません。")
    end
end)

-- +1 Luck購入 v3追加
local BuyLuckBtn = Instance.new("TextButton", Frame)
BuyLuckBtn.Size = UDim2.new(0, 200, 0, 35)
BuyLuckBtn.Text = "+1 Luck 購入"
BuyLuckBtn.BackgroundColor3 = Color3.fromRGB(0, 200, 255)
BuyLuckBtn.TextColor3 = Color3.new(0, 0, 0)
BuyLuckBtn.Font = Enum.Font.GothamBold
BuyLuckBtn.BorderSizePixel = 0

BuyLuckBtn.MouseButton1Click:Connect(function()
    local luckRemote = RS:FindFirstChild("LuckSpeed")
    if luckRemote then
        luckRemote:FireServer()
    else
        warn("RemoteEvent 'LuckSpeed' が見つかりません。")
    end
end)
...
sellBtn.MouseButton1Click:Connect(function()
    ...
    if deleteRemote then
        ...
        warn("RemoteEvent 'DeleteHeldBrainrot' が見つかりません。")
    end
end)
